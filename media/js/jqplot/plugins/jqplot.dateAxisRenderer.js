...
(function($) {
    ...
    var formatedDate = $.jsDate.strftime(val, format);
        formatedDate = formatedDate.replace('Jan', 'Январь');
        formatedDate = formatedDate.replace('Feb', 'Февраль');
        formatedDate = formatedDate.replace('Mar', 'Март');
        formatedDate = formatedDate.replace('Apr', 'Апрель');
        formatedDate = formatedDate.replace('May', 'Май');
        formatedDate = formatedDate.replace('Jun', 'Июнь');
        formatedDate = formatedDate.replace('Jul', 'Июль');
        formatedDate = formatedDate.replace('Aug', 'Август');
        formatedDate = formatedDate.replace('Sep', 'Сентябрь');
        formatedDate = formatedDate.replace('Oct', 'Октябрь');
        formatedDate = formatedDate.replace('Nov', 'Ноябрь');
        formatedDate = formatedDate.replace('Dec', 'Декабрь');

        formatedDate = formatedDate.replace('Monday', 'Понедельник');
        formatedDate = formatedDate.replace('Tuesday', 'Вторник');
        formatedDate = formatedDate.replace('Wednesday', 'Среда');
        formatedDate = formatedDate.replace('Thursday', 'Четверг');
        formatedDate = formatedDate.replace('Friday', 'Пятница');
        formatedDate = formatedDate.replace('Saturday', 'Суббота');
        formatedDate = formatedDate.replace('Sunday', 'Воскресение');
